...
def generate_launch_description():
    ...
    # URDF路径
    default_urdf_path = os.path.join(package_share_path, 'urdf', 'test_robot.urdf')
    ...
    action_load_joint_state_controller = launch_ros.actions.Node(
        ...
        executable='spawner',
        arguments=['test_joint_state_broadcaster', '--controller-manager', '/controller_manager'],
    )
    ...
    action_load_diff_drive_controller = launch_ros.actions.Node(
        package='controller_manager',
        executable='spawner',
        arguments=['test_diff_drive_controller', '--controller-manager', '/controller_manager'],
    )
